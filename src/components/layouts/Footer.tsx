...
export const Footer = () => {
	return (
		<Section bg='bg-[#12141D]'>
			<div className='grid grid-cols-1 sm:grid-cols-2 pl-[20px] pb-[20px] md:pb-0 md:pl-0 md:flex pt-[38px] md:pt-[76px] h-fit md:h-[440px]'>
				<div>
				...
				<div className='flex sm:flex-col md:flex-row sm:gap-[20px] md:gap-[75px] ml-[20px] sm:ml-[41px]'>
				...
				<div className='md:ml-[108px]'>
					<div>
						<h1 className='text-[16px] qmd:text-[20px] text-white font-bold leading-[32px] mb-[8px]'>
