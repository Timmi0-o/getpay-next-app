		...
		<Section bg='bg-[#FAFCFE]'>
			<div className='flex justify-between items-center pt-[50px]'>
				<div className='flex flex-col gap-[32px]'>
					<h1 className='text-[50px] leading-[72px] font-semibold'>
						Earn the money and <br /> get bonuses
					</h1>
					<p className='text-[16px] font-medium leading-[32px] text-[#A3A4A7] max-w-[494px]'>
				...
				<div className='relative'>
					<div className='relative w-[392px] h-[578px]'>
						<Image src={'/banner-mini.svg'} fill alt='banner-mini' />
					</div>
					<div className='absolute top-[290px] right-[180px] w-[374px] h-[230px]'>
						<Image src={'/card-banner.svg'} fill alt='banner-mini' />
					</div>
					<div className='absolute top-[50px] right-[100px] w-[374px] h-[230px]'>
